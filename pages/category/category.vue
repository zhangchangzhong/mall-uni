		...
		<view class="category-list">
			...
			<scroll-view  scroll-y="true" class="right" >
			    <view class="category" v-for="(category,index) in categoryList" :key="category.id" v-show="index==showCategoryIndex" >
					<view class="banner">
						<image src="http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20190129/99d3279f1029d32b929343b09d3c72de_222_222.jpg"></image>
					</view>
					<view class="list">
...
<script>
	...
	export default {
		...
		methods: {
			async loadData(){
					const res = 	await api.getGoodsCategory();
					if(res.code===200){
